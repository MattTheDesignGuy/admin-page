...
export function Dashboard() {
  ...
  useEffect(() => {
    api.get<DashboardSummary>('/api/dashboard/summary').then(setSummary).catch(() => setSummary(null))
  }, [])
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <p className="text-eyebrow text-indigo">{summary?.fy.label ?? 'This financial year'}</p>
