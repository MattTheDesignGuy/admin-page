...
export function IncomeUpload() {
  ...
  return (
    <div className="mx-auto flex max-w-2xl flex-col gap-6">
      <div>
        <p className="text-eyebrow text-indigo">Income</p>
        <h1 className="text-h1">Log income</h1>
        <p className="mt-1 text-sm text-ink-muted">
          Drop a TDG invoice PDF — Claude pulls out the fields, you confirm before it's saved.
        </p>
      </div>
